	...
	private void initialize() {
		...
		btnRequest.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				pnlMenu.setVisible(false);
				pnlRequestBook.setVisible(true);
			}
		});
		...
		txtAreaSearch.addKeyListener(new KeyAdapter() {
			@Override
		...
		pnlRequestBook = new JPanel();
		frmLibrary.getContentPane().add(pnlRequestBook, "name_2593557961007");
		
		JLabel lblNewLabel_2 = new JLabel("Request a book");
		lblNewLabel_2.setFont(new Font("Dialog", Font.ITALIC, 16));
		
		JButton btnRequestBookBack = new JButton("Back");
		btnRequestBookBack.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				pnlRequestBook.setVisible(false);
				pnlMenu.setVisible(true);
			}
		});
		GroupLayout gl_pnlRequestBook = new GroupLayout(pnlRequestBook);
		gl_pnlRequestBook.setHorizontalGroup(
			gl_pnlRequestBook.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnlRequestBook.createSequentialGroup()
					.addGroup(gl_pnlRequestBook.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_pnlRequestBook.createSequentialGroup()
							.addGap(307)
							.addComponent(lblNewLabel_2, GroupLayout.PREFERRED_SIZE, 137, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_pnlRequestBook.createSequentialGroup()
							.addContainerGap()
							.addComponent(btnRequestBookBack)))
					.addContainerGap(323, Short.MAX_VALUE))
		);
		gl_pnlRequestBook.setVerticalGroup(
			gl_pnlRequestBook.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnlRequestBook.createSequentialGroup()
		...
		pnlRequestBook.setLayout(gl_pnlRequestBook);
	}
}
